...
func makeCardItem(id: Int, tag: Tag, title: String, startAt: String, endAt: String, img: String, heart: Bool) -> CardItem {
  return CardItem(id: id, tag: tag, title: title, startAt: startAt, endAt: endAt, img: img, heart: heart, checked: false)
}
